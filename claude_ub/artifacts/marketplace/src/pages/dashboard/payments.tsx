...
import { DownloadCloud, CreditCard, DollarSign, Clock, X, Printer, Loader2, Package } from "lucide-react";
          ...
          <div className="border rounded-xl overflow-hidden">
            <div className="bg-primary p-6 text-primary-foreground">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-2xl font-black">دليل بلس</h2>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <p className="text-xs text-muted-foreground">دليل بلس © {new Date().getFullYear()}</p>
              </div>
            </div>
          </div>
        </div>
