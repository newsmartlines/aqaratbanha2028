...
import { Loader2, Send, MessageSquare, ArrowRight, User } from "lucide-react";
...
export default function ProviderInbox() {
  ...
  const selectedConv = inbox.find((c: any) => c.otherId === selectedId);
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                  {convLoading ? (
                    ...
                    <div className="text-center py-8 text-sm text-muted-foreground">لا توجد رسائل — ابدأ المحادثة!</div>
                  ) : (
