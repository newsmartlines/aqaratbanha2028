...
import { api, type ProviderStats, type ProviderInteractions } from "@/lib/api";
    ...
    return (
      <ProviderLayout>
        <div className="p-8 text-center">
          ...
          <p className="text-lg font-medium">يرجى تسجيل الدخول كمقدم خدمة للوصول للوحة التحكم.</p>
        </div>
      </ProviderLayout>
    );
  }
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-primary/5 p-6 rounded-2xl border border-primary/10">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-secondary overflow-hidden border-2 border-white shadow-sm">
              {user.avatar ? (
          ...
          <Card className="lg:col-span-1 border-primary/20 shadow-md bg-gradient-to-br from-background to-primary/5">
            ...
            <CardContent>
              {statsLoading ? (
                ...
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">لا يوجد اشتراك نشط. اشترك الآن للحصول على مزيد من الطلبات.</p>
                  <Link href="/dashboard/subscription">
