...
export default function ProviderLayout({ children }: ProviderLayoutProps) {
  ...
  const dashboardNav = [
    ...
    { name: "الاشتراك",     href: "/dashboard/subscription",  icon: Crown },
    { name: "خدماتي",       href: "/dashboard/services",      icon: List },
    { name: "الطلبات",      href: "/dashboard/orders",        icon: Bell },
    { name: "الرسائل",      href: "/dashboard/inbox",         icon: MessageCircleIcon },
    { name: "التقييمات",    href: "/dashboard/reviews",       icon: Star },
    { name: "المدفوعات",    href: "/dashboard/payments",      icon: CreditCard },
    { name: "الإعدادات",    href: "/dashboard/settings",      icon: Settings },
    { name: "المساعدة",     href: "/dashboard/support",       icon: HelpCircle },
  ];
    ...
    <div className="flex h-full flex-col bg-teal-900 text-white">
      ...
      <div className="flex h-14 shrink-0 items-center px-5 border-b border-white/10 lg:hidden">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-white flex items-center justify-center text-teal-800 font-bold text-lg">د</div>
    ...
    <div className="min-h-screen bg-background font-sans" dir="rtl">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          ...
          {/* Right side: provider pill + mobile triggers */}
