...
const DEFAULT_SETTINGS: Record<string, string> = {
  siteName: "دليل بلس",
  siteNameEn: "Dalel Plus",
  logoUrl: "",
  primaryColor: "#0d9488",
  aboutContent: "نحن منصة دليل بلس، الوجهة الأولى للخدمات المنزلية والمحلية في المملكة العربية السعودية.",
  ...
  heroSubtitle: 'سواء كنت تبحث عن طعام بيتي لذيذ، أو حرف يدوية متقنة، أو خدمات صيانة موثوقة، "دليل بلس" يربطك بأفضل مقدمي الخدمات في منطقتك.',
