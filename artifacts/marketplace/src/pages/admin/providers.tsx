              ...
              <Table>
                <TableHeader className="bg-slate-50">
                  <TableRow>
                    ...
                    <TableHead className="font-semibold text-slate-700 text-center">العقارات المنشورة</TableHead>
                  ...
                  {filtered.length === 0 ? (
                    ...
                    return (
                      <TableRow
                        ...
                        onClick={() => setLocation(`/admin/providers/${p.id}`)}
                      >
                        ...
                        <TableCell className="text-center font-semibold text-teal-700">{(p as any).publishedPropertiesCount ?? 0}</TableCell>
                        <TableCell>
