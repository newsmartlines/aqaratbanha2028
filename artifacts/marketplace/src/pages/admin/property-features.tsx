...
import {
  ...
  ChevronUp, ChevronDown, Search, Tag,
...
function IconPicker({ value, onChange }: {
  ...
  const icons = FEATURE_ICONS_LIST;
  return (
    <div>
...
export default function AdminPropertyFeatures() {
  ...
  const openAdd = () => {
    setEditing(null);
    setForm({ name: "", icon: "Home", status: "active", applicableTypes: [] });
    setModalOpen(true);
  };
    ...
    <AdminLayout>
      <div className="p-6 space-y-6" dir="rtl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-800">مميزات العقار</h1>
            <p className="text-sm text-slate-500 mt-1">
              إدارة مميزات العقارات التي تظهر في نماذج الإضافة والبحث
            </p>
          </div>
          <Button
            onClick={openAdd}
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
              ...
              <p className="font-semibold text-slate-600">
                {search ? "لا توجد نتائج مطابقة" : "لا توجد مميزات بعد"}
              </p>
              {!search && (
        ...
        <DialogContent className="sm:max-w-[480px]" dir="rtl">
          ...
          <div className="space-y-5 pt-2">
            ...
            <div>
              ...
              <Input
                placeholder="مثال: مسبح، جراج مغطى..."
                value={form.name}
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mb-3">
                اتركه فارغاً لتطبيقه على جميع الأنواع، أو اختر الأنواع المحددة التي تظهر فيها هذه الميزة.
              </p>
