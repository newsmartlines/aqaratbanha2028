...
const dict = {
  ...
  pricePerMo: { ar: "السعر/شهر (ر.س)", en: "Price/Mo (SAR)" },
  ...
  boost7: { ar: "تمييز 7 أيام (ر.س)", en: "7 Days Boost (SAR)" },
  boost14: { ar: "تمييز 14 يوم (ر.س)", en: "14 Days Boost (SAR)" },
  boost30: { ar: "تمييز 30 يوم (ر.س)", en: "30 Days Boost (SAR)" },
  ...
  priceLbl: { ar: "السعر (ر.س/شهر)", en: "Price (SAR/mo)" },
