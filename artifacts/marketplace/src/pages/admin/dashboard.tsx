...
const dict = {
  ...
  revenueDesc: { ar: "نمو الإيرادات الشهرية بالريال السعودي", en: "Monthly revenue growth in SAR" },
  ...
  act3: { ar: "تمت معالجة دفعة بقيمة 500 ر.س", en: "Payment of 500 SAR processed" },
