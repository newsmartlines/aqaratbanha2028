...
export default function DashboardOverview() {
  ...
  const userStats = [
    { name: "عقاراتي المعلنة", value: String((myProperties as any[]).length), icon: Building2, color: "text-teal-600", bg: "bg-teal-500/10", href: "/dashboard/properties" },
    { name: "المفضلة", value: String((favorites as any[]).length), icon: Heart, color: "text-rose-500", bg: "bg-rose-500/10", href: "/dashboard/favorites" },
    { name: "تنبيهات البحث", value: String((savedSearches as any[]).length), icon: BellRing, color: "text-blue-500", bg: "bg-blue-500/10", href: "/dashboard/saved-searches" },
  ...
  // ── Provider-specific computed values ────────────────────────────────────────
  const kpiCards = [
    { label: "عدد عقاراتي", value: stats?.totalProperties ?? 0, icon: Building2, color: "text-blue-600", bg: "bg-blue-500/10", border: "border-blue-200/60 dark:border-blue-800/40", accent: "from-blue-500/5", href: "/dashboard/properties", suffix: "عقار" },
    { label: "إجمالي المشاهدات", value: stats?.totalViews ?? 0, icon: Eye, color: "text-violet-600", bg: "bg-violet-500/10", border: "border-violet-200/60 dark:border-violet-800/40", accent: "from-violet-500/5", href: "/dashboard/properties", suffix: "مشاهدة" },
    { label: "ضغطات الهاتف", value: stats?.totalPhoneClicks ?? 0, icon: Phone, color: "text-emerald-600", bg: "bg-emerald-500/10", border: "border-emerald-200/60 dark:border-emerald-800/40", accent: "from-emerald-500/5", href: "/dashboard/properties", suffix: "ضغطة" },
    { label: "العقارات النشطة", value: stats?.activeProperties ?? 0, icon: CheckCircle2, color: "text-teal-600", bg: "bg-teal-500/10", border: "border-teal-200/60 dark:border-teal-800/40", accent: "from-teal-500/5", href: "/dashboard/properties", suffix: "نشط" },
    { label: "العقارات المميزة", value: stats?.featuredProperties ?? 0, icon: Sparkles, color: "text-amber-600", bg: "bg-amber-500/10", border: "border-amber-200/60 dark:border-amber-800/40", accent: "from-amber-500/5", href: "/dashboard/properties", suffix: "مميز" },
  ];
  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500" dir="rtl">
        ...
        {/* ── Provider: waiting for providerId hydration ────────────────────── */}
        ...
        {/* ════════════════════════════════════════════════════════════════════
            HERO BANNER — conditional per role
        ════════════════════════════════════════════════════════════════════ */}
        ...
        {/* Provider: KPI section header + cards */}
        {isProvider && (
          <>
        ...
        {/* ════════════════════════════════════════════════════════════════════
            USER: Quick links + Recent notifications
        ════════════════════════════════════════════════════════════════════ */}
        {!isProvider && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
