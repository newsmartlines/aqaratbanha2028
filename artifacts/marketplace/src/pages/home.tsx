          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {homePropsRaw.slice(0, 9).map((property, idx) => {
                ...
                const waPhone = (property as any).whatsapp || (property as any).phone || "";
                const waLink = waPhone ? `https://wa.me/2${waPhone.replace(/^0/, "")}?text=${encodeURIComponent(`مرحباً، أنا مهتم بعقار: ${property.title}`)}` : null;
                return (
                <motion.div
                  key={property.id}
                      ...
                      <div className="absolute bottom-0 inset-x-0 px-3 pb-3 flex items-end justify-between z-20">
                        ...
                        {waLink && (
                          <a
                            ...
                            className="flex items-center gap-1.5 bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg transition-all hover:scale-105 active:scale-95"
                          >
