            ...
            <div className="p-6 sm:p-8 space-y-5 animate-in fade-in slide-in-from-right-4 duration-400">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type={showPass ? "text" : "password"} dir="ltr" value={form.password} autoComplete="new-password"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Lock className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400" />
                  <Input type={showConfirm ? "text" : "password"} dir="ltr" value={form.confirmPassword} autoComplete="new-password"
