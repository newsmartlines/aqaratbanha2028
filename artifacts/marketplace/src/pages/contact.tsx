          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 rounded-2xl border border-border/40 bg-card shadow-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{settings?.contactEmail ?? "info@aqaralex.com"}</p>
                </div>
              </div>
              ...
              {settings?.contactWhatsapp && (
                <a
                  ...
                  className="flex items-start gap-4 p-4 rounded-2xl border border-border/40 bg-card shadow-sm hover:border-green-500/40 transition-colors"
                >
                  <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center shrink-0">
                    <MessageCircle className="w-5 h-5 text-green-600" />
                  </div>
                  <div>
                    <p className="font-semibold text-sm text-muted-foreground mb-0.5">واتساب</p>
                    <p className="font-medium" dir="ltr">{settings.contactWhatsapp}</p>
                  </div>
                </a>
              )}
            ...
            {settings?.workingHours && (
              <div className="bg-primary/5 border border-primary/20 rounded-2xl p-5">
                <p className="text-sm font-semibold text-foreground/80 mb-1">ساعات العمل</p>
                <p className="text-sm text-foreground/70 leading-relaxed whitespace-pre-line">{settings.workingHours}</p>
              </div>
            )}
          </div>
