...
const GOVERNORATES: Record<string, string> = {
  ...
  "القليوبية": "القليوبية", "قليوبية": "القليوبية",
...
const CITIES_MAP: Record<string, string> = {
  // القليوبية
  "بنها": "بنها", "بنهـا": "بنها",
  "شبرا الخيمة": "شبرا الخيمة", "شبرا": "شبرا الخيمة",
  "قليوب": "قليوب",
  "القناطر الخيرية": "القناطر الخيرية", "القناطر": "القناطر",
  "الخانكة": "الخانكة",
  "شبين القناطر": "شبين القناطر",
  "كفر شكر": "كفر شكر",
  "طوخ": "طوخ",
  "أبو زعبل": "أبو زعبل", "ابو زعبل": "أبو زعبل",
  "المنشية": "المنشية", "المنشيه": "المنشية",
  "الزهراء": "الزهراء", "الزهراء الجديدة": "الزهراء",
  "الشرابي": "الشرابي",
  "الحي العاشر": "الحي العاشر", "المنطقة العاشرة": "الحي العاشر",
  // القاهرة الكبرى
  "مدينة نصر": "مدينة نصر",
