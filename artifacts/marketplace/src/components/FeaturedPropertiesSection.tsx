      ...
      {visible && (
        ...
        >
          ...
          <div className="p-3" dir="rtl">
            ...
            <p className="text-primary text-base leading-none mb-2 text-right">
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={getPromotionCardStyle((property as any).activePromotion ?? null)}
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        {/* Promotion badge (any active promotion or plain featured flag) */}
                        {((property as any).activePromotion || isFeatured) && (
                          <div className="absolute bottom-3 left-3 z-20 pointer-events-none">
                            <PromotionBadge
                              size="md"
                              promotion={(property as any).activePromotion ?? (isFeatured ? { type: "featured_homepage", boostScore: 500, expiresAt: null } : null)}
                            />
                          </div>
                        )}
