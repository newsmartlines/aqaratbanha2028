...
export const CITY_AREAS: Record<string, string[]> = {
  "بنها": [
    "وسط البلد", "المنطقة الصناعية", "حي الجامعة", "حي النزهة", "حي الجيزة",
    "حي السلام", "حي النيل", "حي الشاطبي", "المنشية", "العجمي",
    "الكيلو 20", "بنها الجديدة",
  ],
  "قليوب": [
    "وسط المدينة", "حي الأندلس", "حي النصر", "حي الزيتون", "الحي الصناعي",
    "منشية القناطر", "حي الشروق",
  ],
  "شبرا الخيمة": [
    "شبرا الخيمة أول", "شبرا الخيمة ثانية", "شبرا الخيمة ثالثة", "شبرا الخيمة رابعة",
    "الطوابق", "حي النور", "الحي الصناعي",
  ],
  "القناطر": [
    "القناطر الخيرية", "منشأة الصدر", "بلبيس الجديدة", "المنطقة الزراعية",
  ],
  "طوخ": [
    "وسط طوخ", "حي المساكن", "المنطقة الصناعية", "الأراضي الزراعية",
  ],
  "كفر شكر": [
    "وسط كفر شكر", "حي المساكن", "المنطقة الزراعية",
  ],
};
