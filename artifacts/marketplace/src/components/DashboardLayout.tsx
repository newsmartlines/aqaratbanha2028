...
// Currently empty — add provider-exclusive nav items here when provider-specific pages are created.
const PROVIDER_NAV = [] as const;

// Currently empty — add user-exclusive nav items here when user-specific pages are created.
