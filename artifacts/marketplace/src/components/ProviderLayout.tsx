      ...
      <div className="px-4 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-xl overflow-hidden border-2 border-white/25 shadow-lg shrink-0">
            {user?.avatar ? (
              <img src={user.avatar} alt={displayName} className="w-full h-full object-contain bg-white/10" />
            ) : (
          ...
          <div className="min-w-0">
            ...
            <span className="inline-flex items-center gap-1 mt-0.5 px-2 py-0.5 rounded-full text-[10px] font-medium bg-white/15 text-blue-100 border border-white/20">
        ...
        <nav className="space-y-0.5">
          {dashboardNav.map((item) => {
            ...
            return (
              ...
              >
                <item.icon className={`ml-3 shrink-0 h-4 w-4 ${isActive ? "text-blue-300" : "text-blue-300/60 group-hover:text-white"}`} />
